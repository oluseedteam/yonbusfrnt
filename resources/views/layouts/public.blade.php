...
<body class="antialiased flex flex-col min-h-screen" style="background: #FFFFFF; color: #475569;">
    ...
    <header class="sticky top-0 z-50 bg-white border-b border-blue-100 shadow-sm" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between" style="height: 74px;">
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 14px;">
                        ...
                        <div style="display: flex; gap: 12px; align-items: flex-start;">
                            ...
                            <div style="font-size: 0.82rem; color: rgba(148,163,184,0.9); line-height: 1.6;">Gatineau, Quebec, Canada</div>
                        </div>
