<x-public-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    <span style="font-size: 11px; font-weight: 800; color: #93c5fd; text-transform: uppercase; letter-spacing: 0.08em; background: rgba(0,82,255,0.18); padding: 4px 14px; border-radius: 999px; border: 1px solid rgba(59,130,246,0.35); width: fit-content;">
                        ABOUT US
                    </span>
                    <h2 class="font-heading font-extrabold" style="color: #ffffff; font-size: clamp(1.8rem, 4vw, 2.5rem); line-height: 1.2;">
                        Who We Are
                    </h2>
                    <p style="color: #cbd5e1; font-size: 1rem; line-height: 1.75;">
                        <strong style="color: #60a5fa;">Yonbus Tax & Accounting Services Inc.</strong> is a trusted partner committed to delivering reliable, efficient and compliant tax and accounting solutions to individuals, businesses and organizations across Canada.
                    </p>
                    <p style="color: #cbd5e1; font-size: 1rem; line-height: 1.75;">
                    ...
                    <div style="background: rgba(0, 43, 138, 0.4); border: 1px solid rgba(59,130,246,0.3); border-radius: 20px; padding: 24px 28px; color: #ffffff; margin-top: 0.5rem; position: relative; backdrop-filter: blur(10px);">
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <h3 class="font-heading font-bold" style="color: #ffffff; font-size: 1.5rem; margin-bottom: 0.5rem;">
                        What We Stand For
                    </h3>
                    ...
                    @foreach($values as $v)
                    <div style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 16px; padding: 20px; display: flex; align-items: flex-start; gap: 16px; backdrop-filter: blur(10px);">
                        <div style="width: 44px; height: 44px; border-radius: 12px; background: rgba(0,82,255,0.15); border: 1px solid rgba(0,82,255,0.3); display: flex; align-items: center; justify-content: center; font-size: 1.3rem; flex-shrink: 0;">
                            {{ $v['icon'] }}
                        </div>
                        <div>
                            <h4 class="font-heading font-bold" style="color: #ffffff; font-size: 1.05rem; margin-bottom: 4px;">{{ $v['title'] }}</h4>
                            <p style="color: #94a3b8; font-size: 0.88rem; line-height: 1.55;">{{ $v['desc'] }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
    ...
    <section style="background: #030F30; padding: 4rem 0; border-top: 1px solid rgba(255,255,255,0.08);">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span style="font-size: 11px; font-weight: 800; color: #93c5fd; text-transform: uppercase; letter-spacing: 0.08em; background: rgba(0,82,255,0.18); padding: 4px 14px; border-radius: 999px; border: 1px solid rgba(59,130,246,0.35); display: inline-block;">Follow Us</span>
            <h2 class="font-heading font-extrabold" style="color: #ffffff; font-size: clamp(1.5rem, 3vw, 2rem); margin: 0.5rem 0 0.75rem;">Connect With YONBUS on Social Media</h2>
            <p style="color: #94a3b8; font-size: 0.95rem; margin-bottom: 2rem;">Stay updated with tax tips, financial news, and company updates.</p>
            <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; flex-wrap: wrap;">

                {{-- Facebook --}}
                <a href="https://facebook.com/yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 14px; text-decoration: none; color: #f1f5f9; font-size: 0.88rem; font-weight: 600; transition: all 0.2s;"
                   onmouseenter="this.style.background='rgba(24,119,242,0.3)'; this.style.borderColor='rgba(24,119,242,0.5)';"
                ...
                <a href="https://instagram.com/yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 14px; text-decoration: none; color: #f1f5f9; font-size: 0.88rem; font-weight: 600; transition: all 0.2s;"
                   onmouseenter="this.style.background='rgba(214,36,159,0.3)'; this.style.borderColor='rgba(214,36,159,0.5)';"
                   onmouseleave="this.style.background='rgba(255,255,255,0.04)'; this.style.borderColor='rgba(255,255,255,0.1)';">
                ...
                <a href="https://tiktok.com/@yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 14px; text-decoration: none; color: #f1f5f9; font-size: 0.88rem; font-weight: 600; transition: all 0.2s;"
                   onmouseenter="this.style.background='rgba(255,255,255,0.12)'; this.style.borderColor='rgba(255,255,255,0.3)';"
                   onmouseleave="this.style.background='rgba(255,255,255,0.04)'; this.style.borderColor='rgba(255,255,255,0.1)';">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="#ffffff"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>
                    TikTok
                </a>
                ...
                <a href="https://x.com/yonbustax" target="_blank" rel="noopener"
                   ...
                   onmouseenter="this.style.background='rgba(255,255,255,0.12)'; this.style.borderColor='rgba(255,255,255,0.3)';"
                   onmouseleave="this.style.background='rgba(255,255,255,0.04)'; this.style.borderColor='rgba(255,255,255,0.1)';">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#ffffff"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.258 5.63L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    X (Twitter)
                </a>
                ...
                <a href="https://linkedin.com/company/yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 14px; text-decoration: none; color: #f1f5f9; font-size: 0.88rem; font-weight: 600; transition: all 0.2s;"
                   onmouseenter="this.style.background='rgba(0,119,181,0.3)'; this.style.borderColor='rgba(0,119,181,0.5)';"
                   onmouseleave="this.style.background='rgba(255,255,255,0.04)'; this.style.borderColor='rgba(255,255,255,0.1)';">
    ...
    <section style="position: relative; overflow: hidden; background: linear-gradient(135deg, #002B8A 0%, #0045d8 50%, #0052FF 100%); padding: 4.5rem 0; text-align: center; color: #ffffff;">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" style="position: relative; z-index: 1;">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="{{ route('register') }}" style="background: #ffffff; color: #0052ff; font-weight: 700; font-size: 0.95rem; padding: 14px 30px; border-radius: 12px; text-decoration: none; box-shadow: 0 8px 24px rgba(0,0,0,0.15); transition: all 0.2s;"
