<x-public-layout>
    ...
    {{-- Social Media Section (Light Theme) --}}
    <section style="background: #f8faff; padding: 4rem 0; border-top: 1px solid #e2e8f0;">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span style="font-size: 11px; font-weight: 800; color: #0052ff; text-transform: uppercase; letter-spacing: 0.08em; background: #eff6ff; padding: 5px 16px; border-radius: 999px; border: 1px solid #bfdbfe; display: inline-block;">Follow Us</span>
            ...
            <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; flex-wrap: wrap;">
                ...
                <a href="https://facebook.com/yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: #ffffff; border: 1.5px solid #dbeafe; border-radius: 14px; text-decoration: none; color: #0a1a4a; font-size: 0.88rem; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.04); transition: all 0.2s;"
                   onmouseenter="this.style.borderColor='#1877F2'; this.style.transform='translateY(-2px)';"
                   onmouseleave="this.style.borderColor='#dbeafe'; this.style.transform='translateY(0)';">
                ...
                <a href="https://instagram.com/yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: #ffffff; border: 1.5px solid #dbeafe; border-radius: 14px; text-decoration: none; color: #0a1a4a; font-size: 0.88rem; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.04); transition: all 0.2s;"
                   onmouseenter="this.style.borderColor='#d6249f'; this.style.transform='translateY(-2px)';"
                   onmouseleave="this.style.borderColor='#dbeafe'; this.style.transform='translateY(0)';">
                ...
                <a href="https://tiktok.com/@yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: #ffffff; border: 1.5px solid #dbeafe; border-radius: 14px; text-decoration: none; color: #0a1a4a; font-size: 0.88rem; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.04); transition: all 0.2s;"
                   onmouseenter="this.style.borderColor='#0052ff'; this.style.transform='translateY(-2px)';"
                   onmouseleave="this.style.borderColor='#dbeafe'; this.style.transform='translateY(0)';">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="#0a1a4a"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>
                    TikTok
                </a>
                ...
                <a href="https://x.com/yonbustax" target="_blank" rel="noopener"
                   ...
                   onmouseenter="this.style.borderColor='#0052ff'; this.style.transform='translateY(-2px)';"
                   onmouseleave="this.style.borderColor='#dbeafe'; this.style.transform='translateY(0)';">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#0a1a4a"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.258 5.63L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    X (Twitter)
                </a>
                ...
                <a href="https://linkedin.com/company/yonbustax" target="_blank" rel="noopener"
                   style="display: flex; align-items: center; gap: 10px; padding: 12px 20px; background: #ffffff; border: 1.5px solid #dbeafe; border-radius: 14px; text-decoration: none; color: #0a1a4a; font-size: 0.88rem; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.04); transition: all 0.2s;"
                   onmouseenter="this.style.borderColor='#0A66C2'; this.style.transform='translateY(-2px)';"
                   onmouseleave="this.style.borderColor='#dbeafe'; this.style.transform='translateY(0)';">
