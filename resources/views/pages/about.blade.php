<x-public-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                ...
                <div style="display:flex;flex-direction:column;gap:1.5rem;">
                    <div>
                        <span style="display:inline-block;background:#EFF6FF;border:1.5px solid #BFDBFE;color:#2563EB;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:0.08em;padding:5px 16px;border-radius:999px;margin-bottom:1rem;">
                            About Us
                        </span>
                        <h2 class="font-heading font-extrabold" style="color:#1E3A8A;font-size:clamp(1.8rem,4vw,2.5rem);line-height:1.2;margin-bottom:1rem;">
                            Who We Are
                        </h2>
                        <div style="display:flex;flex-direction:column;gap:1rem;">
                            <p style="color:#374151;font-size:1rem;line-height:1.8;">
                                <strong style="color:#1E3A8A;">Yonbus Tax &amp; Accounting Services Inc.</strong> is a trusted partner committed to delivering reliable, efficient and compliant tax and accounting solutions to individuals, businesses and organizations across Canada.
                            </p>
                            <p style="color:#374151;font-size:1rem;line-height:1.8;">
                    ...
                    {{-- Mission Quote --}}
                    <div style="background:linear-gradient(135deg,#EFF6FF,#DBEAFE);border:2px solid #BFDBFE;border-left:4px solid #2563EB;border-radius:16px;padding:24px 28px;position:relative;">
                        <div style="font-size:2.5rem;color:#2563EB;font-family:Georgia,serif;line-height:0.8;margin-bottom:8px;opacity:0.6;">"</div>
                        <p style="font-size:1rem;font-style:italic;line-height:1.7;color:#1E3A8A;font-weight:500;">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div style="background:#EFF6FF;border:2px solid #DBEAFE;border-radius:16px;padding:18px 12px;text-align:center;">
                            <div class="font-heading font-extrabold" style="font-size:1.6rem;color:#1E3A8A;line-height:1;">{{ $s['num'] }}</div>
                            <div style="font-size:0.75rem;color:#2563EB;font-weight:700;margin-top:4px;text-transform:uppercase;letter-spacing:0.04em;">{{ $s['label'] }}</div>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div style="display:flex;flex-direction:column;gap:1rem;">
                    <div>
                        ...
                        <h3 class="font-heading font-bold" style="color:#1E3A8A;font-size:1.5rem;margin-bottom:1.25rem;">
                            What We Stand For
                        </h3>
                    </div>
                    ...
                    @foreach($values as $v)
                    <div style="background:#ffffff;border:2px solid #DBEAFE;border-radius:16px;padding:20px;display:flex;align-items:flex-start;gap:16px;transition:all 0.25s;"
                         onmouseenter="this.style.borderColor='#2563EB';this.style.boxShadow='0 6px 24px rgba(37,99,235,0.14)';this.style.transform='translateX(4px)';"
                         onmouseleave="this.style.borderColor='#DBEAFE';this.style.boxShadow='none';this.style.transform='translateX(0)';">
                        <div style="width:48px;height:48px;border-radius:14px;background:#EFF6FF;border:2px solid #BFDBFE;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0;">
                            {{ $v['icon'] }}
                        </div>
                        <div>
                            <h4 class="font-heading font-bold" style="color:#1E3A8A;font-size:1rem;margin-bottom:5px;">{{ $v['title'] }}</h4>
        ...
        <div class="bg-[#F8FAFC] py-14 sm:py-16 border-b border-blue-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div style="background:#ffffff;border:2px solid #DBEAFE;border-radius:20px;padding:28px 22px;box-shadow:0 6px 24px rgba(37,99,235,0.08);transition:all 0.3s;"
                         onmouseenter="this.style.borderColor='#2563EB';this.style.transform='translateY(-4px)';this.style.boxShadow='0 16px 36px rgba(37,99,235,0.16)';"
                         onmouseleave="this.style.borderColor='#DBEAFE';this.style.transform='translateY(0)';this.style.boxShadow='0 6px 24px rgba(37,99,235,0.08)';">
                        <div style="width:52px;height:52px;background:#EFF6FF;border:2px solid #BFDBFE;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.5rem;margin:0 auto 14px;">{{ $f['icon'] }}</div>
                        <h4 class="font-heading font-bold" style="color:#1E3A8A;font-size:1.05rem;margin-bottom:8px;text-align:center;">{{ $f['title'] }}</h4>
                        <p style="color:#475569;font-size:0.88rem;line-height:1.65;text-align:center;">{{ $f['desc'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
    ...
    <section class="overflow-hidden">
        <div class="bg-gradient-to-r from-slate-900 via-[#1E3A8A] to-[#2563EB] text-white py-14 sm:py-16 text-center px-4 sm:px-6 lg:px-8 relative">
            <div class="max-w-4xl mx-auto space-y-4">
                <span class="text-xs font-bold uppercase tracking-widest text-blue-200 bg-white/10 px-4 py-1.5 rounded-full border border-white/20 backdrop-blur-md inline-block">
                    Connect With Us
                </span>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div style="display:flex;justify-content:center;align-items:center;gap:12px;flex-wrap:wrap;">
                    <a href="https://facebook.com/yonbustax" target="_blank" rel="noopener"
                       style="display:flex;align-items:center;gap:9px;padding:12px 20px;background:#EFF6FF;border:2px solid #BFDBFE;border-radius:14px;text-decoration:none;color:#1D4ED8;font-size:0.88rem;font-weight:700;transition:all 0.2s;"
                       onmouseenter="this.style.background='#1877F2';this.style.borderColor='#1877F2';this.style.color='#ffffff';"
                       onmouseleave="this.style.background='#EFF6FF';this.style.borderColor='#BFDBFE';this.style.color='#1D4ED8';">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
            ...
            <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;padding-top:1rem;">
                <a href="{{ route('register') }}"
                   style="background:#ffffff;color:#1D4ED8;font-weight:700;font-size:0.95rem;padding:14px 30px;border-radius:12px;text-decoration:none;box-shadow:0 8px 24px rgba(0,0,0,0.2);transition:all 0.2s;display:inline-flex;align-items:center;gap:8px;"
