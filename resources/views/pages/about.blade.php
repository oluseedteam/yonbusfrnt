<x-public-layout>
    ...
    <section class="bg-gradient-to-r from-slate-900 via-[#002B8A] to-[#005DFF] text-white py-20" data-aos="fade-down">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
            ...
            <p class="text-blue-100 text-lg max-w-2xl mx-auto font-light">Combining chartered accounting precision with high-performance SaaS client portal technology.</p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-slate-50 p-8 rounded-3xl border border-slate-200 space-y-6 shadow-sm" data-aos="fade-left">
                    ...
                    <ul class="space-y-3 text-sm text-slate-700">
                        ...
                        <li class="flex items-center"><span class="w-2 h-2 rounded-full bg-[#005DFF] mr-3"></span>Canada Revenue Agency (CRA) Electronic Filing Practitioner</li>
                        <li class="flex items-center"><span class="w-2 h-2 rounded-full bg-[#005DFF] mr-3"></span>Canadian Payroll Association Certified Professionals</li>
                        <li class="flex items-center"><span class="w-2 h-2 rounded-full bg-[#005DFF] mr-3"></span>Bank-Grade 256-Bit SSL Encrypted Storage Protocol</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="space-y-8" data-aos="fade-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <div class="bg-slate-50 rounded-2xl p-8 border border-slate-200 text-center space-y-4 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h3 class="text-xl font-bold font-heading text-slate-900">Sarah Johnson, CPA</h3>
                        <p class="text-xs font-semibold text-[#005DFF] uppercase tracking-wider">Senior CPA & Corporate Tax Lead</p>
                    ...
                    <div class="bg-slate-50 rounded-2xl p-8 border border-slate-200 text-center space-y-4 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h3 class="text-xl font-bold font-heading text-slate-900">Michael Brown, CA</h3>
                        <p class="text-xs font-semibold text-[#005DFF] uppercase tracking-wider">Financial Advisory & Payroll Partner</p>
                        <p class="text-slate-600 text-xs leading-relaxed">Expert in small business bookkeeping systems, cloud payroll automation, and strategic cash flow forecasting.</p>
                    </div>
                </div>
            </div>
        </div>
