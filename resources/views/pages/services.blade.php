<x-public-layout>
    ...
    <section class="overflow-hidden" data-aos="fade-up">
        ...
        <div class="bg-gradient-to-r from-[#031B4E] via-[#031B4E] to-[#005DFF] text-white py-16 sm:py-20 text-center px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="bg-white py-14 sm:py-16 border-b border-blue-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div style="background:#ffffff;border:2px solid #CBD5E1;border-radius:20px;padding:32px 28px;display:flex;flex-direction:column;justify-content:space-between;box-shadow:0 6px 24px rgba(37,99,235,0.08);transition:all 0.3s ease;"
                         onmouseenter="this.style.borderColor='#005DFF';this.style.boxShadow='0 16px 40px rgba(37,99,235,0.16)';this.style.transform='translateY(-4px)';"
                         onmouseleave="this.style.borderColor='#CBD5E1';this.style.boxShadow='0 6px 24px rgba(37,99,235,0.08)';this.style.transform='translateY(0)';">
                        <div>
                            <div style="width:54px;height:54px;border-radius:14px;background:#F1F5F9;border:2px solid #CBD5E1;display:flex;align-items:center;justify-content:center;font-size:1.5rem;margin-bottom:20px;">
                                {{ $icon }}
                            </div>
                            <h3 class="font-heading font-bold" style="color:#031B4E;font-size:1.15rem;margin-bottom:12px;text-transform:uppercase;letter-spacing:0.02em;">{{ $service->name }}</h3>
                        ...
                        <div style="margin-top:20px;padding-top:16px;border-top:1.5px solid #F1F5F9;">
                            <a href="{{ route('book-appointment') }}?service={{ $service->id }}"
                               style="display:block;width:100%;text-align:center;background:#005DFF;color:#ffffff;font-weight:700;font-size:0.88rem;padding:12px 20px;border-radius:12px;text-decoration:none;box-shadow:0 4px 14px rgba(37,99,235,0.3);transition:all 0.2s;"
                               onmouseenter="this.style.background='#031B4E';this.style.boxShadow='0 8px 24px rgba(37,99,235,0.45)';this.style.transform='translateY(-1px)';"
                               onmouseleave="this.style.background='#005DFF';this.style.boxShadow='0 4px 14px rgba(37,99,235,0.3)';this.style.transform='translateY(0)';">
                                Book Consultation &rarr;
                            </a>
                        </div>
                    </div>
                    @empty
                        <div class="col-span-3 text-center py-16 rounded-2xl border-2 border-[#CBD5E1]" style="background:#F1F5F9;color:#475569;">
                            <div style="font-size:3rem;margin-bottom:1rem;">📋</div>
                            <p style="font-size:1rem;font-weight:600;color:#031B4E;">Services are being configured. Please check back soon.</p>
                        </div>
                    @endforelse
                </div>
            </div>
    ...
    {{-- ── BOTTOM CTA BANNER ────────────────────────────── --}}
    <section class="relative overflow-hidden py-16 sm:py-20 text-center" style="background:linear-gradient(135deg, #0f172a 0%, #031B4E 50%, #005DFF 100%);">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
            ...
            <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;padding-top:1rem;">
                <a href="{{ route('contact') }}" style="background:#ffffff;color:#031B4E;font-weight:700;font-size:0.95rem;padding:14px 30px;border-radius:12px;text-decoration:none;box-shadow:0 8px 24px rgba(0,0,0,0.15);transition:all 0.2s;"
