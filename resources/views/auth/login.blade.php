...
<div class="auth-wrapper">
    ...
    <div class="auth-card">
        ...
        <div class="social-buttons">
            ...
            <button class="btn-social" type="button">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M11.5 2.2H2.2v9.3h9.3V2.2z" fill="#F25022"/><path d="M21.8 2.2h-9.3v9.3h9.3V2.2z" fill="#7FBA00"/><path d="M11.5 12.5H2.2v9.3h9.3v-9.3z" fill="#00A4EF"/><path d="M21.8 12.5h-9.3v9.3h9.3v-9.3z" fill="#FFB900"/></svg>
                Microsoft
            </button>
        </div>
