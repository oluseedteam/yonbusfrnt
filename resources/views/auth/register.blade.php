...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-title { font-size: 24px; font-weight: 800; color: #0B1F4B; margin-bottom: 6px; letter-spacing: -0.4px; }
        .card-sub { font-size: 13px; color: #64748B; margin-bottom: 24px; }

        .form-row-2 { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
        .form-group { margin-bottom: 16px; }
        .form-label { display: block; font-size: 13px; font-weight: 600; color: #1E293B; margin-bottom: 5px; }
        .form-input {
            width: 100%;
            padding: 12px 15px;
            font-size: 14px;
        ...
        .pw-strength-label { font-size: 11px; color: #94A3B8; }
        ...
        .terms-row label { font-size: 13px; color: #475569; line-height: 1.5; cursor: pointer; }
...
<div class="auth-wrapper">
    ...
    <div class="auth-card">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-top: 8px;">
                    ...
                    <label id="card-olubukunola" class="consultant-card" style="border: 2px solid #005DFF; background: #F0F6FF; border-radius: 16px; padding: 14px 12px; cursor: pointer; display: flex; flex-direction: column; align-items: center; text-align: center; position: relative; transition: all 0.2s; box-shadow: 0 4px 12px rgba(0, 93, 255, 0.08);">
                        ...
                        <img src="/images/team/olubukunola-eniola.jpg" alt="Olubukunola Eniola (CPB)" style="width: 58px; height: 58px; border-radius: 50%; object-fit: cover; border: 2.5px solid #005DFF; margin-bottom: 8px;">
                        <span style="font-size: 13px; font-weight: 800; color: #0B1F4B; line-height: 1.2;">Olubukunola Eniola (CPB)</span>
                    </label>
                    ...
                    <label id="card-adeshola" class="consultant-card" style="border: 1.5px solid #D1DCF0; background: #FAFCFF; border-radius: 16px; padding: 14px 12px; cursor: pointer; display: flex; flex-direction: column; align-items: center; text-align: center; position: relative; transition: all 0.2s;">
                        ...
                        <img src="/images/team/adeshola-eniola.jpg" alt="Adeshola Eniola (CPB)" style="width: 58px; height: 58px; border-radius: 50%; object-fit: cover; border: 2.5px solid #CBD5E1; margin-bottom: 8px;">
                        <span style="font-size: 13px; font-weight: 800; color: #0B1F4B; line-height: 1.2;">Adeshola Eniola (CPB)</span>
                    </label>
                </div>
            </div>
        ...
        <div class="social-buttons" style="grid-template-columns: 1fr;">
            <a href="{{ route('auth.google') }}" class="btn-social" style="width: 100%; justify-content: center; text-decoration: none;">
