<div>
    ...
    @if (session()->has('message'))
        <div class="mb-6 p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 text-xs font-semibold">
            {{ session('message') }}
        </div>
    @endif
        ...
        <div class="card-box">
            ...
            <form wire:submit.prevent="updatePreferences" class="space-y-4 text-xs">
                <div class="flex items-center justify-between p-3.5 rounded-xl bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <input type="checkbox" wire:model="email_notifications" class="rounded text-[#2563EB] focus:ring-[#2563EB]">
                </div>
                ...
                <div class="flex items-center justify-between p-3.5 rounded-xl bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <input type="checkbox" wire:model="sms_reminders" class="rounded text-[#2563EB] focus:ring-[#2563EB]">
                </div>
        ...
        <div class="card-box">
            ...
            <form wire:submit.prevent="updatePassword" class="space-y-4 text-xs">
                <div>
                    ...
                    <input type="password" wire:model="current_password" class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 py-2 px-3 focus:ring-[#2563EB]">
                ...
                <div>
                    ...
                    <input type="password" wire:model="new_password" class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 py-2 px-3 focus:ring-[#2563EB]">
                ...
                <div>
                    ...
                    <input type="password" wire:model="new_password_confirmation" class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 py-2 px-3 focus:ring-[#2563EB]">
                </div>
