<div x-data="{ cancelModal: { open: false, id: null } }">
    <!-- Header -->
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/40">
                            ...
                            <td class="p-3.5 text-right space-x-2">
                                @if(in_array($appt->status, ['pending', 'confirmed']))
                                    ...
                                    <button type="button" @click="cancelModal = { open: true, id: {{ $appt->id }} }" class="text-red-500 hover:underline font-semibold cursor-pointer">Cancel</button>
                                @endif
                            </td>
                        </tr>
                    @empty
    ...
    >
        ...
        >
            ...
            <h3 class="text-base font-bold text-gray-900 dark:text-white font-heading">Cancel Appointment?</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">
                Are you sure you want to cancel this consultation? You can always reschedule or book a new time later.
            </p>
