<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex space-x-3">
            <button wire:click="exportCsv" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl shadow-md transition flex items-center">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden space-y-4 p-6">
        ...
        <table class="w-full text-left text-sm border-collapse">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="py-6 text-center text-slate-500 dark:text-slate-400">No report generation history found. Click "Export Excel / CSV" to generate one.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
