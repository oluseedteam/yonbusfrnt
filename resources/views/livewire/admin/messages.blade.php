    ...
    <div class="flex-1 card-box p-0 flex flex-col h-full overflow-hidden">
        ...
        @if($activeClient)
            <form wire:submit.prevent="send" class="p-4 border-t border-gray-100 dark:border-gray-800 flex items-center gap-3 bg-white dark:bg-gray-900">
                <input type="text" wire:model="body" placeholder="Type a reply to {{ $activeClient->first_name }}..." class="flex-1 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl py-2.5 px-4 text-xs focus:ring-[#2563EB] focus:border-[#2563EB]">
