...
>
                    ...
                    @forelse ($documents as $doc)
                        ...
                        <tr class="hover:bg-slate-50/70 dark:hover:bg-slate-700/30 transition">
                            ...
                            <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                                ...
                                <button type="button" @click="deleteModal = { open: true, id: {{ $doc->id }}, name: '{{ addslashes($doc->original_name) }}' }" class="px-2.5 py-1.5 text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/40 font-semibold text-xs rounded-xl transition cursor-pointer">
                                    🗑️ Delete
                                </button>
                            </td>
                        </tr>
    ...
    >
        ...
        >
            ...
            <h3 class="text-base font-bold text-slate-900 dark:text-white font-heading">Delete Document?</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
                Are you sure you want to delete <span class="font-semibold text-slate-800 dark:text-slate-200" x-text="deleteModal.name"></span>? This action cannot be undone.
            </p>
